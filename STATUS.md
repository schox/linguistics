...
The vault currently holds 291 notes, of which 51 are subfield hub stubs and 81 are topic stubs so the whole taxonomy is visible in the graph. Decipherment is no longer a skeleton; every other area's content still is, though its shape now shows.
...
- **Cryptography**: 3 written notes and 81 topic stubs, across 102 files. Three of fourteen subfields are stubbed out in full (Cryptanalysis, Classical ciphers, Symmetric cryptography). The subfield vocabulary was rebuilt on 2026-08-12 against three published classifications (see the area index); 14 subfields, of which **Cryptanalysis** is the first to be stubbed out in full. The other 13 hold no content note at all.
