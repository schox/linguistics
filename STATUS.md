...
The vault currently holds 206 notes, of which 51 are subfield hub stubs so the whole taxonomy is visible in the graph. Decipherment is no longer a skeleton; every other area's content still is, though its shape now shows.
...
- **Cryptography**: 3 content notes across 17 files. The subfield vocabulary was rebuilt on 2026-08-12 against three published classifications (see the area index); 14 subfields, 11 of them with no content note at all.
