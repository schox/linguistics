...
The vault currently holds 608 notes, of which 14 are subfield hub stubs and 397 are topic stubs so the whole taxonomy is visible in the graph. Decipherment is no longer a skeleton; every other area's content still is, though its shape now shows.
