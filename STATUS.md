...
The vault currently holds 200 notes, of which 47 are the subfield hub stubs added 2026-08-12 so the whole taxonomy is visible in the graph. Decipherment is no longer a skeleton; every other area's content still is, though its shape now shows.
