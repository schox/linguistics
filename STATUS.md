...
The vault currently holds 520 notes, of which 28 are subfield hub stubs and 309 are topic stubs so the whole taxonomy is visible in the graph. Decipherment is no longer a skeleton; every other area's content still is, though its shape now shows.
