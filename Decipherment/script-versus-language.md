...
- **Neither known**: the [Indus script](indus-script.md), Rongorongo. No established method exists for this case, and it is not clear that one can exist below the evidentiary threshold.
